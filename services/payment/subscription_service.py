...
class SubscriptionService:
    ...
    def activate(user_id: str, stripe_subscription_id: str, plan: str = 'pro') -> dict:
        ...
        try:
            ...
            logger.error("activate 실패: %s", e, exc_info=True)
            return {}
    ...
    def upgrade(user_id: str, new_plan: str) -> dict:
        ...
        try:
            ...
            logger.error("upgrade 실패: %s", e, exc_info=True)
            return {}
    ...
    def downgrade(user_id: str, new_plan: str) -> dict:
        ...
        try:
            ...
            logger.error("downgrade 실패: %s", e, exc_info=True)
            return {}
    ...
    def cancel(user_id: str) -> dict:
        ...
        try:
            ...
            logger.error("cancel 실패: %s", e, exc_info=True)
            return {}
