...
_KIND_KEYWORDS = {
    "bug": ["안돼", "안 돼", "안됨", "오류", "에러", "버그", "깨져", "멈춰", "실패", "안보여", "안 보여", "안 눌", "안 열"],
...
_FILE_HINTS = [
    ...
    (re.compile(r"모델|cliproxy|cli.?proxy|gpt|glm|serve|login|provider|프로바이더"), ["config.py", "frontend/hooks/useProviders.ts", "routes/utility/operations.py"]),
