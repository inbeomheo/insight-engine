...
class FeedbackStore:
    ...
    def create_ticket(self, payload: dict[str, Any], user_id: str | None = None) -> dict[str, Any]:
        ...
        ticket = {
            ...
            "priority": payload.get("priority") or payload.get("severity") or "medium",
            "title": title[:140],
            "message": str(payload.get("message") or "").strip(),
            "route": payload.get("route") or "",
            "current_url": payload.get("current_url") or "",
            "selected_provider": payload.get("selected_provider") or "",
            "selected_model": payload.get("selected_model") or "",
            "generation_mode": payload.get("generation_mode") or "",
            "selected_style": payload.get("selected_style") or "",
            "detail_level": payload.get("detail_level") or "",
