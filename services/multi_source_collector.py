...
def _collect_podcast(url: str) -> Dict:
    ...
    # Spotify 에피소드
    from services.spotify_service import is_spotify_episode_url
    if is_spotify_episode_url(url):
        from services.spotify_service import get_episode_info
    ...
    from services.whisper_service import download_audio, transcribe_audio, _cleanup_file
