...
class TestVersionService(unittest.TestCase):
    ...
    def test_save_and_list_versions(self):
        from services.version_service import save_version, list_versions
    ...
    def test_get_version(self):
        from services.version_service import save_version, get_version
    ...
    def test_restore_version(self):
        from services.version_service import save_version, restore_version, list_versions
    ...
    def test_max_versions_limit(self):
        from services.version_service import save_version, list_versions, MAX_VERSIONS_PER_CONTENT
        for i in range(MAX_VERSIONS_PER_CONTENT + 10):
            save_version('c1', f'제목{i}', f'내용{i}')

        from services.version_service import _versions
...
class TestSearchService(unittest.TestCase):
    ...
    def test_index_and_search(self):
        from services.search_service import index_content, search
...
class TestFolderService(unittest.TestCase):
    ...
    def test_create_and_list_folders(self):
        from services.folder_service import create_folder, list_folders
        create_folder('기술')
        create_folder('마케팅')
    ...
    def test_delete_folder(self):
        from services.folder_service import create_folder, delete_folder, list_folders
        f = create_folder('삭제용')
    ...
    def test_move_content(self):
        from services.folder_service import create_folder, move_content, get_content_folder, list_folder_contents
        f = create_folder('폴더1')
    ...
    def test_move_to_uncategorized(self):
        from services.folder_service import create_folder, move_content, get_content_folder
        f = create_folder('폴더1')
    ...
    def test_update_folder(self):
        from services.folder_service import create_folder, update_folder
...
class TestNotificationService(unittest.TestCase):
    ...
    def test_mark_read(self):
        from services.notification_service import create_notification, mark_read, list_notifications
    ...
    def test_delete_notification(self):
        from services.notification_service import create_notification, delete_notification, list_notifications
        n = create_notification('user1', 'system', '테스트', '메시지')
    ...
    def test_max_notifications(self):
        from services.notification_service import create_notification, MAX_NOTIFICATIONS_PER_USER
        from services import notification_service
...
class TestCollaborationService(unittest.TestCase):
    ...
    def test_update_content(self):
        from services.collaboration_service import create_session, update_content
    ...
    def test_leave_session(self):
        from services.collaboration_service import create_session, leave_session, get_session
        r = create_session('c1', 'user1')
    ...
    def test_heartbeat(self):
        from services.collaboration_service import create_session, heartbeat
        r = create_session('c1', 'user1')
