...
// HTML 내보내기
export async function exportHtml(title: string, content: string, html?: string): Promise<Blob> {
  return requestBlob('/api/export/html', { method: 'POST', body: JSON.stringify({ title, content, html }) });
}
