            ...
            >
              ...
              {msg.role === 'assistant' && msg.sources && msg.sources.length > 0 && (
                <div className="mt-2 pt-2 border-t border-border/40">
                  <button
                    type="button"
                    className="flex min-h-11 w-full items-center gap-1 rounded-md px-2 text-left text-xs text-muted-foreground transition-colors hover:bg-background/50 hover:text-foreground"
