...
describe('ContentEditor', () => {
  ...
  it('모바일에서도 저장·취소 터치 영역이 최소 44px이다', async () => {
    await renderEditor();
    expect(findButton('취소').className).toContain('h-11');
    expect(findButton('저장').className).toContain('h-11');
  });
  ...
  it('저장 중에는 Esc가 편집기를 닫지 않는다', async () => {
