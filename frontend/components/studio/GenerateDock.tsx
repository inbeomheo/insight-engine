  ...
  return (
    <section className="sticky bottom-4 z-20 rounded-[24px] border border-indigo-100 bg-white/90 p-3 shadow-lg shadow-indigo-100/70 backdrop-blur-xl">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div><p className="text-xs font-semibold text-indigo-700">Ready to Generate</p><p data-testid="generate-dock-summary" className="text-sm text-slate-500">소스 {sourceCount}개 · 모드 {modeLabel}</p></div>
