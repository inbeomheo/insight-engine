...
export default function StudioResultToolbar({
  ...
  return (
    <section
      ...
      role="region"
      aria-labelledby="studio-result-toolbar-title"
    ...
    >
      <div className="mb-4 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <h2 id="studio-result-toolbar-title" data-testid="studio-result-toolbar-title" className="mt-1 text-lg font-semibold text-slate-950">생성 결과 관리</h2>
          <p id="studio-result-toolbar-summary" data-testid="studio-result-toolbar-summary" role="status" aria-live="polite" className="mt-1 text-sm text-slate-500">
      ...
      {totalCount > 0 ? (
        <div data-testid="result-toolbar-filter-panel" role="group" aria-label="결과 필터" className="rounded-2xl bg-slate-50 p-3">
