...
**4. 광고/홍보 콘텐츠 제외**
- 스폰서십, 광고, 유료 협찬 내용은 제외하세요
- 할인 코드, 프로모션 링크, 쿠폰 언급은 생략하세요
- "구독", "좋아요", "알림 설정" 등의 CTA(행동 유도)는 제외하세요
- 영상의 실질적 내용에만 집중하세요
...
## 타임코드 활용 규칙
- 입력에 **[타임스탬프 자막]** 섹션이 있으면 각 주요 섹션 시작 부분에 `[HH:MM:SS]` 형식의 타임코드를 포함하세요
- 타임코드는 해당 내용이 영상에서 시작되는 시간을 나타냅니다
- 타임코드가 없는 입력에서는 타임코드를 절대 지어내지 마세요
- 타임코드 형식 예시: `[00:02:05]` (2분 5초)
