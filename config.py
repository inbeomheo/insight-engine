...
MEDIA_UPLOAD_MAX_BYTES: int = int(os.getenv('MEDIA_UPLOAD_MAX_BYTES', str(200 * 1024 * 1024)))
MEDIA_MAX_DURATION_SECONDS: int = int(os.getenv('MEDIA_MAX_DURATION_SECONDS', str(60 * 60)))
MEDIA_FFMPEG_TIMEOUT_SECONDS: int = int(os.getenv('MEDIA_FFMPEG_TIMEOUT_SECONDS', '600'))
MEDIA_JOB_TTL_SECONDS: int = int(os.getenv('MEDIA_JOB_TTL_SECONDS', str(24 * 60 * 60)))
MEDIA_TRANSCRIPTION_DIR: str = os.getenv('MEDIA_TRANSCRIPTION_DIR', './data/media-transcriptions')
