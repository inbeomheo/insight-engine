...
def get_structured_transcript(video_id):
    ...
    if isinstance(transcript_data, dict) and 'error' in transcript_data:
        ...
        return api_error(error_message, 422)
    ...
    if isinstance(transcript_data, dict):
        ...
        return api_error('자막 데이터 형식이 올바르지 않습니다.', 500)

    if not text or not text.strip():
        return api_error('자막이 비어 있습니다.', 422)
    ...
    try:
        ...
        return api_error('[서버 오류] 자막 가공 중 문제가 발생했습니다.', 500)
