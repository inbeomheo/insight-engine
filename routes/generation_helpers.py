...
def _build_generation_response_payload(result, report_id, used_prompt, elapsed_time,
                                       youtube_title, raw_transcript,
                                       transcript_source, style, comments,
                                       comment_result, seo=None, geo=None,
                                       faq_schema=None, cta=None,
                                       json_ld_schemas=None, quality_score=None,
                                       web_sources=None, analysis=None,
                                       transcript_segments=None, chapters=None,
                                       total_duration_seconds=0, quota=None,
                                       agent_meta=None):
    """Build the final generation response JSON payload."""
    return {
        **result,
        "id": report_id,
        "prompt": used_prompt,
...
def _save_and_respond(result, used_prompt, comment_result, cache_key,
    ...
    return jsonify(_build_generation_response_payload(
        result=result,
        report_id=report_id,
